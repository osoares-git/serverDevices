...
class SystemTrayIcon(QtWidgets.QSystemTrayIcon):
    def __init__(self, icon, parent=None):
        ...
        self.my = MyApp()
        self.my.show_from_tray()  # Isso restaura a janela criada no momento de criação da tray
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def start_server(self):
        ...
        if port.isdigit():
            ...
            hora_inicio = datetime.datetime.now().strftime("%d/%m/%Y às %H:%M:%S")
...
if __name__ == "__main__":
    ...
    trayIcon.show()
    # window.show() #Eliminar essa linha para que haja apenas a janela exibida pela tray, pois o inicio será pela tray
    sys.exit(app.exec_())
